...
HD_PWD='D:/SDUP_2020_projekt_H/Huffman/Huffman.runs/impl_5'
cd "$HD_PWD"
...
EAStep vivado -log huffman_decoder.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source huffman_decoder.tcl -notrace
