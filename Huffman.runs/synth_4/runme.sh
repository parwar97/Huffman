...
HD_PWD='D:/SDUP_2020_projekt_H/Huffman/Huffman.runs/synth_4'
cd "$HD_PWD"
...
EAStep vivado -log huffman_decoder.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source huffman_decoder.tcl
